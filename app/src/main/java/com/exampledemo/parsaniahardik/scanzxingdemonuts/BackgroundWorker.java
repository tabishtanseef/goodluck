...
public class BackgroundWorker extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://www.funed.in/app_login.php";
        String signup_url = "http://www.funed.in/app_register.php";
        String insertBook_url = "http://www.funed.in/app_insertBook.php";
